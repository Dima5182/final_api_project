...
def test_get_all_meme(get_all_meme_endpoint, get_token_endpoint):
    ...
    get_all_meme_endpoint.check_response_json_is_not_empty()
...
def test_get_one_meme(get_one_meme_endpoint, get_token_endpoint, object_id):
    ...
    get_one_meme_endpoint.check_response_id_is_correct(object_id)
...
def test_delete_meme(delete_meme_endpoint, get_one_meme_endpoint, get_token_endpoint, object_id):
    delete_meme_endpoint.delete_meme(object_id, get_token_endpoint.get_token())
    get_one_meme_endpoint.get_one_meme(id=object_id, token=get_token_endpoint.get_token())
...
def test_put_meme(change_meme_endpoint, get_token_endpoint, object_id, data):
    ...
    change_meme_endpoint.check_response_url_is_correct(data['url'])
    change_meme_endpoint.check_response_info_is_correct(data['info'])
    change_meme_endpoint.check_response_tags_are_correct(data['tags'])
